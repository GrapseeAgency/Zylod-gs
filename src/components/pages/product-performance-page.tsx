...
export function ProductPerformancePagePage() {
  ...
  return (
    ...
    >
      ...
      <header className="md:hidden sticky top-0 z-50 bg-white border-b px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-lg md:text-2xl font-semibold text-gray-900">Product Performance</h1>
      </header>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm">
                  Content for Product Performance will be populated from the API.
                </p>
              </CardContent>
            </Card>
          </div>
...
export default ProductPerformancePagePage;
