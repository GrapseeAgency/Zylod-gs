...
export function SellerCustomerInsightsPagePage() {
  ...
  return (
    ...
    >
      ...
      <header className="md:hidden sticky top-0 z-50 bg-white border-b px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-lg md:hidden font-semibold text-gray-900">Customer Insights</h1>
      </header>

      <h1 className="hidden md:block text-2xl font-semibold text-gray-900">Customer Insights</h1>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm">
                  Content for Customer Insights will be populated from the API.
                </p>
              </CardContent>
            </Card>
          </div>
...
export default SellerCustomerInsightsPagePage;
