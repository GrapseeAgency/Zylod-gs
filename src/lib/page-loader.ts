...
const REAL_PAGES = new Set([
  ...
  'admin-dashboard', 'admin-payments', 'admin-users', 'admin-products', 'admin-reports', 'admin-moderation', 'admin-suppliers', 'admin-analytics', 'supplier-dashboard', 'buyer-dashboard',
